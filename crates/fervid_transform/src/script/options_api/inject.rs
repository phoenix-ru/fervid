...
#[inline]
pub fn collect_inject_bindings_object(obj_lit: &ObjectLit, options_api_bindings: &mut OptionsApiBindings) {
...
/// https://vuejs.org/api/options-composition.html#inject
#[inline]
pub fn collect_inject_bindings_array(arr: &ArrayLit, options_api_bindings: &mut OptionsApiBindings) {
